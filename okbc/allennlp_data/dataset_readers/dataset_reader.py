...
class DatasetReader(Registrable):
    ...
    def set_worker_info_int(self, info_int, total) -> None:
        self._worker_info = WorkerInfo(info_int, total)
    ...
    def shard_iterable(self, iterable: Iterable[_T]) -> Iterator[_T]:
        ...
        if util.is_distributed():
            ...
            sharded_slice = itertools.islice(
                sharded_slice, 0, None, self.world_size
            )
