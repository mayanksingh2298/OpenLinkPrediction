...
class SpacyTokenizer(Tokenizer):
    ...
    pos_tags : `bool`, optional, (default=`False`)
        ...
        Generally used in conjunction with :class:`~allennlp_data.token_indexers.pos_tag_indexer.PosTagIndexer`.
    parse : `bool`, optional, (default=`False`)
        If `True`, performs dependency parsing with spacy model on the tokens.
        Generally used in conjunction with :class:`~allennlp_data.token_indexers.pos_tag_indexer.DepLabelIndexer`.
    ner : `bool`, optional, (default=`False`)
        If `True`, performs dependency parsing with spacy model on the tokens.
        Generally used in conjunction with :class:`~allennlp_data.token_indexers.ner_tag_indexer.NerTagIndexer`.
